 ...
 *
 * Will NOT show a warning message from GitHub
 * 
 * To test hit the deploy.php url with a browser
 * 
 * @var boolean
 */
if(defined('ACTIVE') && ACTIVE===false)
{
	echo '
		<h2>Deployment currently shut off</h2>
		<p>Please go into your config file and set <b>ACTIVE</b> to true</p>
		';
	die();
