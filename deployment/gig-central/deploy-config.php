...
/**
 * Added 8/4/2015
 * Will shut off deploy if false
 *
 * Will NOT show a warning message
 * 
 * To test hit the deploy.php url with a browser
 * 
 * @var boolean
 */
define('ACTIVE', false); 
...
//make your own ugly string here 
define('SECRET_ACCESS_TOKEN', 'hg8qphapsasgeq75eryqt3q4thf348hqsr340hq34t');
...
//we're using http instead of https in case 
define('REMOTE_REPOSITORY', 'http://github.com/newmanix/itc260-sp15-gig-central.git');
...
//put the path to where your app will reside here
define('TARGET_DIR', '/home/blasch13/blakehschwartz.com/ci-gigcentral/');

//deploy string: http://example.com/deployment/app-name/deploy.php?sat=hg8qphapsasgeq75eryqt3q4thf348hqsr340hq34t
...
//PUT YOUR EMAIL HERE:
define('EMAIL_ON_ERROR', 'blakehschwartz@gmail.com');
